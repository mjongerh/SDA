...
Rerr[2] = R[2] * sqrt( (((x[8]**2 * x[2]**2) / (x[0]**2))*((xerr[8]/x[8])**2 + (xerr[6]/x[6])**2 + (xerr[0]/x[0])**2)**2 +xerr[6]**2) / (R[2]*x[4]) +(xerr[4]/x[4])**2 )
Rerr[3] = R[3] * sqrt( (((x[9]**2 * x[3]**2) / (x[1]**2))*((xerr[9]/x[9])**2 + (xerr[7]/x[7])**2 + (xerr[1]/x[1])**2)**2 +xerr[7]**2) / (R[3]*x[5]) +(xerr[5]/x[5])**2 )
