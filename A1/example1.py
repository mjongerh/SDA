...
histogram_of_pt1 = ROOT.TH1D("histogram_of_pt1","histogram of Pt1", # name and title
                             100, 0, 3000 )  # 100 bins between 0 and 3000 GeV
...
histogram_of_pt1.SetXTitle("tranverse momentum of #mu_{1} (GeV)")
